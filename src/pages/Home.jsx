            ...
            >
              ...
              <div className="flex items-center gap-4 ml-2">
                <motion.a 
                  ...
                  href="https://github.com/rudra-spec07" 
                  target="_blank" rel="noreferrer"
                  className="p-3 bg-slate-800/50 hover:bg-slate-700/80 border border-slate-700 rounded-lg text-slate-400 transition-all backdrop-blur-sm"
                >
                  <FiGithub size={22} />
                </motion.a>
                <motion.a 
                  whileHover={{ y: -4, color: "#fff" }} 
                  href="https://www.linkedin.com/in/rudra-kumar-choubey-09b553318/" 
                  target="_blank" rel="noreferrer"
                  className="p-3 bg-slate-800/50 hover:bg-slate-700/80 border border-slate-700 rounded-lg text-slate-400 transition-all backdrop-blur-sm"
                >
                  <FiLinkedin size={22} />
